  ...
  <Link to={props.link} className="card" href="#">
    <div className="card__wrap">
      ...
      <div className="card__content card__content--top">
        <span className="card__titles card__titles--main" dangerouslySetInnerHTML={{__html: props.title}} />
      </div>
      <div className="card__content card__content">
        <span className="card__titles card__titles--subtitle" dangerouslySetInnerHTML={{__html: props.subtitle}} />
      </div>
