...
const menuButton = (props) => {
  ...
  <div className="hamburger" onClick={props.clicked}>
    <div 
      className={props.open ? `${topClasses} hamburger__open-line--rotate-top` : topClasses}></div>
    <div className={props.open ? `${bottomClasses} hamburger__open-line--rotate-bottom` : bottomClasses}></div>
  </div>  
  )
};
